...
public:
    ...
    inline void setVec3(const std::string &name, const vec3 &value) const;
    inline void setVec3(const std::string &name, float x, float y, float z) const;
    inline void setVec4(const std::string &name, const vec4 &value) const;
    inline void setVec4(const std::string &name, float x, float y, float z, float w) const;
    inline void setMat4(const std::string &name, const mat4 &mat) const;
};
...
{
    glUniformMatrix4fv(glGetUniformLocation(ID, name.c_str()), 1, GL_TRUE, mat.value_ptr());
}
